...
var MovieForm = React.createClass({
	...
	render: function () {
		var cancelBtn = this.props.edition
			? <button className="btn btn-danger pull-right" onClick={this.props.onCancel}>Cancel</button>
			: false;
		var saveButton = this.props.movie && this.props.movie.id
		...
		return (
			<form className="form-horizontal" onSubmit={this.onSubmit}>
				...
				<div className="form-group">
					<label className="col-sm-4 control-label">Réalisateur :
					</label>
					<div className="col-sm-7">
